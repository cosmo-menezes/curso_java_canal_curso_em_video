...
public class telaTriangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sliC.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        sliC.setMaximum(20);
        sliC.setValue(0);
        ...
        sliA.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        sliA.setMaximum(20);
        sliA.setValue(0);
        ...
        sliB.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        sliB.setMaximum(20);
        sliB.setValue(0);
        ...
        lblA.setText("0");
        lblA.setToolTipText("0");

        lblB.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblB.setText("0");
        lblB.setToolTipText("0");

        lblC.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblC.setText("0");
        lblC.setToolTipText("0");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/triangulo-abc1.png"))); // NOI18N
